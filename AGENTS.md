# Agent Operating Instructions for promptlintel

This file defines how AI agents and human maintainers should work in `promptlintel`.
...
```md
## Review Pack
Repo: rogerchappel/promptlintel
Branch:
PR:
Task:
