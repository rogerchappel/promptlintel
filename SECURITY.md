...
Replace this section with the supported versions for `../promptlintel`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `../promptlintel` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in ../promptlintel.
